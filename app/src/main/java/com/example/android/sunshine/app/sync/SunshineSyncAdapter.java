...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    protected static void fitchDataFromServer(Context context) {
    ...
    private static void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                mContentResolver.bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, cvArray);
            }
     ...
     */
    static long addLocation(String locationSetting, String cityName, double lat, double lon) {
        long locationId;
